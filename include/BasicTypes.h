...
enum ObjectType {
	CLASS_INSTANCE, STRING_INSTANCE, ARRAY
};
typedef enum ObjectType ObjectType;

enum ValueType {
	BOOLEAN, BYTE, CHAR, SHORT, INT, FLOAT, LONG, DOUBLE, RETURN_ADDR, REFERENCE, PADDING // usado quando o Value anterior (em uma lista) ou o Value abaixo (em uma pilha) é um long/double
};
...
struct attribute_info {
	...
	union {
		...
		Deprecated_attribute1 deprecated_info1;
	} info;
};
