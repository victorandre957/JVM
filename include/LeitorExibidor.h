 ...
 * @brief A classe LeitorExibidor contém o necessário para ler o bytecode, exibilo e armazena-lo em memoria
...
public:
	 ...
	 * @param *file Ponteiro para o arquivo .class a ser carregado.
	 */
...
private:
	...
	LeitorExibidor(LeitorExibidor const&); // não permitir implementação do construtor de cópia
	void operator=(LeitorExibidor const&); // não permitir implementação do operador de igual
